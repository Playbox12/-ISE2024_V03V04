...
void escribirLinea_L1(char* mensaje){
int i;
int longitud = strlen(mensaje);
	for(i=0; i < longitud; i++){
		symbolToLocalBuffer_L1(mensaje[i]);
	}
LCD_update_L1();
}

void escribirLinea_L2(char* mensaje){
int i;
int longitud = strlen(mensaje);
	for(i=0; i < longitud; i++){
		symbolToLocalBuffer_L2(mensaje[i]);
	}
LCD_update_L2();
}
